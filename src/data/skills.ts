...
export const SKILLS = [
  ...
  { name: 'Evaluation & Observability', level: 65, category: 'LLM Ops' },
  { name: 'AI Governance', level: 70, category: 'AI / LLM' },
  { name: 'Local LLM Deployment', level: 70, category: 'LLM Ops' },
  { name: 'OpenAI / Anthropic APIs', level: 78, category: 'LLM Ops' },
  { name: 'Embeddings', level: 72, category: 'LLM Ops' },
  { name: 'Structured Outputs / Function Calling', level: 72, category: 'LLM Ops' },
  { name: 'LiteLLM / Model Routing', level: 70, category: 'LLM Ops' },
  { name: 'Streaming Responses', level: 72, category: 'LLM Ops' },
  { name: 'NLP', level: 60, category: 'LLM Ops' },
  { name: 'Ollama', level: 65, category: 'LLM Ops' },
