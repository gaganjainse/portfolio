    ...
    <section id="contact" className="py-24 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-text-muted text-lg mb-8 max-w-2xl mx-auto">
          I'm currently looking for entry-level software engineering roles. If you're hiring or just want to connect, feel free to reach out.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
          <a
            href="mailto:gagan.jain.se@gmail.com"
        ...
        <p className="text-text-muted text-sm">
          Vellore, Tamil Nadu, India · Open to relocation
        </p>
      </div>
    </section>
  )
